...
public class Settings {
     ...
     * MedQuest SIRI
     */
//    public static final String HOST = "www.medquestdiagnostics.com:92/Branch/login.html";//endparsehost
//    public static final String HOME_URL = "http://www.medquestdiagnostics.com:92/Branch/login.html";//endparsehomeurl
//    public static final String NOTIFICATION_URL = "http://www.medquestdiagnostics.com:92/Branch/notifications.html";//endparsehomeurl


    /**
     * MQ SIRI LIVE
     */
    public static final String HOST = "www.medquestdiagnostics.com/Branch/login.html";//endparsehost
    public static final String HOME_URL = "https://www.medquestdiagnostics.com/Branch/login.html";//endparsehomeurl
    public static final String NOTIFICATION_URL = "https://www.medquestdiagnostics.com/Branch/notifications.html";//endparsehomeurl
    ...
    public static final int SPLASH_SCREEN_TIMEOUT = 1000; // milliseconds
    //----------------------------- Splash Setup End --------------------------------------------------
    ...
    public static final int GIF_LOAD_MAX_SECONDS = 6;
